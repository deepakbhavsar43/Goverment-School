...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2019 at 01:23 PM
...
INSERT INTO `school` (`sch_id`, `name`, `address`, `contact_no`, `medium`, `description`, `image`) VALUES
(101, 'Gyan Jyot Vidhyalaya', 'Gyan Jyot Vidhayalaya, opp. Dmart, Parvatgam, Surat', '9825152622', 'Gujarati', '\r\nEducation is considered essential for all. Materiality and spirituality are essential for our all-round development. Education is a unique investment for both present and future.\r\n\r\nIt is a matter of great grief that people are adopting indifferent attitudes towards education. Everyone understands that this is the responsibility of another person. We have not only sat down with a pledge to change this attitude, but have shown it by showing interest.', ''),
...
(106, 'New Model High School', 'new model high school, vijaywada, Andra pradesh', '8958654525', 'Telgu', '\r\nEducation is considered essential for all. Materiality and spirituality are essential for our all-round development. Education is a unique investment for both present and future.\r\n\r\nIt is a matter of great grief that people are adopting indifferent attitudes towards education. Everyone understands that this is the responsibility of another person. We have not only sat down with a pledge to change this attitude, but have shown it by showing interest.', ''),
